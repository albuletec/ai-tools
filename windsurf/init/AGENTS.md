<!-- Starter context file for Cursor and Windsurf. `ait init` copies this to AGENTS.md at the repo root. AGENTS.md is the cross-tool context file, and it is what {instructionsFile} resolves to in every installed item except a Claude Code one. Replace every {curly} placeholder. -->
