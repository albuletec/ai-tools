...
2. Read the project's `CLAUDE.md` (root and any app-specific docs it references) for conventions.
...
3. After all edits: run the project's build, type-check, and lint commands (check `CLAUDE.md` for the right commands).
